    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Recover deleted items or delete them permanently.</p>
        </div>
      </div>
                  ...
                  <CardContent className="p-4 flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0 space-y-1">
                      ...
                      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-[10px] text-muted-foreground">
                        <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> Deleted {new Date(item.deleted_at).toLocaleString()}</span>
                        <span className="flex items-center gap-1"><User className="w-3 h-3" /> By {item.deleted_by_name || "Unknown"}</span>
                      </div>
                    </div>
